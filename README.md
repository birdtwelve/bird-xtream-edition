# Bird IPTV Xtream - A VOD & Live TV Playlist
...
> All credit goes to cool users **BigData** *(VOD Content)* and **Myself** *(LiveTV)* for providing the content this script indexes.
...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/birdtwelve/bird-xtream-edition/tree/main/cloudflare)
...
3. **Copy the Code**  
   ...
   👉 [`/cloudflare/worker.js`](https://github.com/birdtwelve/bird-xtream-edition/blob/main/cloudflare/worker.js)
...
This private IPTV project provides an API interface and does not host any content. All content is provided by third-party sources.
