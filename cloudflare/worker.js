// Bird IPTV Xtream – Cloudflare Worker Edition
...
async function handleRoot() {
  return new Response(`Bird IPTV Xtream (Cloudflare Worker Edition)
    ...
    try {
      let response;
			...
			if (pathname === "/") {
				...
				return Response.redirect("https://epgshare01.online/epgshare01/epg_ripper_ALL_SOURCES1.xml.gz", 302);
